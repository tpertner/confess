...
Concrete references for working with the Honesty Harness.
...
These examples are for practitioners, not beginners. They assume you:

- Know why calibration matters
- Understand metamorphic testing
- Care about adversarial pressure patterns

If you're new to LLM evals, start with the main README, then come back here.
