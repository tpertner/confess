...
def save_results(payload: Dict[str, Any], out_dir: str = "results") -> str:
    ...
    jsonl_path = os.path.join(out_dir, f"run-{ts}.jsonl")
...
def build_arg_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Run Confess YAML suites and write results.")
...
def main() -> int:
    ...
    payload = run_suite(args.suite, provider, trials=args.trials)
    out_path = save_results(payload, out_dir=args.out_dir)
